...
public class Statistics {
    ...
    public static String getTodayData() {
        ...
        sb.append("偷取:" + getData(TimeType.DAY, DataType.COLLECTED));
        sb.append(",帮助:" + getData(TimeType.DAY, DataType.HELPED));
        sb.append(",返水:" + getData(TimeType.DAY, DataType.WATERED));
        return sb.toString();
    }
    ...
    public static String getText() {
        statistics = null;
        Statistics stat = getStatistics();
        StringBuilder sb = new StringBuilder(getData(TimeType.YEAR, DataType.TIME) + "年 : 偷取 ");
        sb.append(getData(TimeType.YEAR, DataType.COLLECTED));
        sb.append(",   帮助 " + getData(TimeType.YEAR, DataType.HELPED));
        sb.append(",   返水 " + getData(TimeType.YEAR, DataType.WATERED));
        sb.append("\n" + getData(TimeType.MONTH, DataType.TIME) + "月 : 偷取 ");
        sb.append(getData(TimeType.MONTH, DataType.COLLECTED));
        sb.append(",   帮助 " + getData(TimeType.MONTH, DataType.HELPED));
        sb.append(",   返水 " + getData(TimeType.MONTH, DataType.WATERED));


        sb.append("\n" + getData(TimeType.DAY, DataType.TIME) + "日 : 偷取 ");
